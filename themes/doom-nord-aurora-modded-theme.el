;;; doom-nord-aurora-modded-theme.el --- a light variant of Nord -*- no-byte-compile: t; -*-
;;
...
(defgroup doom-nord-aurora-modded-theme nil
  "Options for doom-themes"
  :group 'doom-themes)

(defcustom doom-nord-aurora-modded-brighter-modeline nil
  "If non-nil, more vivid colors will be used to style the mode-line."
  :group 'doom-nord-aurora-modded-theme
  :type 'boolean)

(defcustom doom-nord-aurora-modded-brighter-comments nil
  "If non-nil, comments will be highlighted in more vivid colors."
  :group 'doom-nord-aurora-modded-theme
  :type 'boolean)

(defcustom doom-nord-aurora-modded-comment-bg doom-nord-aurora-modded-brighter-comments
  "If non-nil, comments will have a subtle, darker background. Enhancing their
legibility."
  :group 'doom-nord-aurora-modded-theme
  :type 'boolean)

(defcustom doom-nord-aurora-modded-padded-modeline doom-themes-padded-modeline
...
(eval-and-compile
  (defcustom doom-nord-aurora-modded-region-highlight t
...
(def-doom-theme doom-nord-aurora-modded
                ...
                ((bg         '("#2E3440" nil       nil            ))
                 ...
                 (variables      cyan)
                 (numbers        magenta)
                 (region         (pcase doom-nord-aurora-modded-region-highlight
                                   (`frost teal)
                                   (`snowstorm base7)
                                   (_ base4)))
                 (error          red)
                 ...
                 (-modeline-bright doom-nord-aurora-modded-brighter-modeline)
                 (-modeline-pad
                  (when doom-nord-aurora-modded-padded-modeline
                    (if (integerp doom-nord-aurora-modded-padded-modeline) doom-nord-aurora-padded-modeline 4)))

                 (region-fg
                  (when (memq doom-nord-aurora-modded-region-highlight '(frost snowstorm))
                    base0))
                ...
                (((region &override) :foreground region-fg)
                 ...
                 (font-lock-comment-face
                  :foreground comments
                  :background (if doom-nord-aurora-modded-comment-bg (doom-lighten bg 0.05) 'unspecified))
                 (font-lock-doc-face
...
;;; doom-nord-aurora-modded-theme.el ends here
